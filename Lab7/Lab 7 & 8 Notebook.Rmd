...
```{r}
#lm = linear model
# simple regression. y is the dependent variable, x is the independent variable. 
lm(y ~ x, data = "the name of dataset")

# multiple regression. x1, x2..xk are all the independent variables.
lm(y ~ x1 + x2 + x3 + ... + xk, data = dataset)
```
...
# where estimate std. = slope
# where multiple r-squared is included in analysis, explained, % of variation in analysis
# where f-statistic applies to unexplained 
```
