...
Country <- c("Japan", "Canada", "France", "Germany", "United States", "Cuba", "Mexico", "Turkey", "Russia", "Afghanistan", "Mozambique", "Angola")
FemLifeExpectYrs <- c(82.17, 81.29, 81.09, 79.41, 78.24, 77.64, 76.26, 72.23, 66.16, 44.65, 41.37, 38.48)
BirthRatePer1000Ppl <- c(7.64, 10.28, 12.57, 8.21, 13.82, 11.13, 19.71, 18.66, 11.1, 45.46, 37.8, 43.69)
SampleWomensData <- data.frame(Country, FemLifeExpectYrs, BirthRatePer1000Ppl)
